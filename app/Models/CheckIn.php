...
class CheckIn extends Model
{
    ...
    public function getEntityAttribute()
    {
        ...
        return match ($this->entity_type) {
            'distributor'        => MasterDistributor::select('id', 'legal_name', 'trade_name', 'category', 'mobile')
                                        ->find($this->entity_id),
            'secondary_customer' => SecondaryCustomer::select('id', 'shop_name', 'owner_name', 'mobile_number', 'sub_type')
                                        ->find($this->entity_id),
